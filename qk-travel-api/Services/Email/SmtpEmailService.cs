...
<body>
    <div class='container'>
        <div class='header'>
            <h1>🎉 Chào mừng đến với QkTravel!</h1>
        </div>
        <div class='content'>
            <h2>Xác nhận địa chỉ email của bạn</h2>
            <p>Cảm ơn bạn đã đăng ký tài khoản QkTravel. Để hoàn tất quá trình đăng ký, vui lòng xác nhận địa chỉ email của bạn bằng cách nhấp vào nút bên dưới:</p>
        ...
        <div class='footer'>
            <p>&copy; 2026 QkTravel. All rights reserved.</p>
        </div>
    </div>
</body>
</html>";

            await SendEmailAsync(email, "Xác nhận đăng ký tài khoản QkTravel", htmlBody);
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản QkTravel của bạn.</p>
        ...
        <div class='footer'>
            ...
            await SendEmailAsync(email, "Đặt lại mật khẩu QkTravel", htmlBody);
...
<body>
    <div class='container'>
        ...
        <div class='footer'>
            <p>This is an automated message from QkTravel Contact Form</p>
